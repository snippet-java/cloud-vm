...
(function(root, factory) {
	...
	(function($, window) {
		...
		$.formUtils = $.extend($.formUtils || {}, {
			...
			/**
			 * skum fix. Ă¤r talet 05 eller lĂ¤gre ger parseInt rĂ¤tt int annars fĂĽr man 0 nĂ¤r man kĂśr parseInt?
			 *
			 * @param {String} val
			 * @return {Number}
			 */
	...
	(function($) {
		...
		$.formUtils.addValidator({
			...
			validatorFunction: function(url) {
				...
				// - General improvements made by StĂŠphane Moureau <https://github.com/TraderStf>
...
(function($) {
	...
	(function() {
		$(".js-accordion").each(function() {
			...
			var title = accordion.children("li").children(select.title); 

			title.on('click', function(event) {
				event.preventDefault();
				$(this).toggleClass('accordion__title--active').siblings(select.content).slideToggle();
			});
		});
	})();
